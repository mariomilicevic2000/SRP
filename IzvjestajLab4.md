...
Kao i u prethodnim vježbama, prvo aktiviramo virtualno okruženje u pythonu.

Paketi koje instaliramo prije izvršavanja koda: PrettyTable za formatiranje rezultata u tablice,

passlib za hash funkcije

Kompletan kod potreban za rad:
...
time_it je wrapper funkcija koja sluzi za procjenu vremena izvršavanja pojedine kriptografske hash funkcije. U main funkciji se koristi da bi se dobilo prosječno vrijeme izvršavanja kroz veliki broj iteracija.

Ostale funkcije služe kao inicijalizacija za korištene hash funkcije.